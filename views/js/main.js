...
var resizePizzas = function(size) {
  ...
  //completely remove the old interdependent functions and use this simple for loop
  var piz = document.getElementsByClassName("randomPizzaContainer");

    for(var i = 0; i < piz.length; i++){
      piz[i].style.width = size + "px";
    }
